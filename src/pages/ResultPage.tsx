...
export const ResultPage = () => {
  ...
  return (
    <div className="result-page-container fade-in" style={{ maxWidth: '900px', margin: '0 auto', padding: '40px 20px' }}>
      ...
      {/* ヘッダーバナー（結果＝実験完了ビジュアル） */}
      <div className="page-banner page-banner--photo" style={{ backgroundImage: 'url(/result_hero.jpg)' }}>
        <div className="page-banner__inner">
          <div className="portfolio-badge" style={{ background: 'var(--color-primary)', color: '#06131f', display: 'inline-block', marginBottom: '10px' }}>DIAGNOSTIC REPORT</div>
          <h2 style={{ margin: 0, fontSize: 'clamp(26px, 3.4vw, 40px)', fontFamily: 'var(--font-heading)', color: 'var(--text-title)' }}>AI歩行 最終診断レポート</h2>
          <p style={{ margin: '8px 0 0 0', color: 'var(--text-main)', fontSize: '15px' }}>シミュレーション完了。AIモデルが到達した最終世代の歩行適合特性を診断します。</p>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
        ...
        <div className="result-card-panel card" style={{
          ...
          <div style={{
            ...
            <span style={{ fontSize: '13px', color: 'var(--text-muted)', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px' }}>総合歩行評価</span>
          ...
          {/* 右カラム：歩行タイプ解説 */}
          <div>
            <span style={{ fontSize: '12px', color: 'var(--text-muted)', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'block', marginBottom: '8px' }}>獲得モデル特性</span>
            <h3 style={{ fontSize: '24px', fontWeight: '900', color: 'var(--text-title)', margin: '0 0 16px 0', fontFamily: 'var(--font-heading)' }}>
        ...
        <div className="card" style={{
          ...
          <h4 style={{ fontSize: '15px', fontWeight: '800', color: 'var(--text-title)', margin: '0 0 20px 0', letterSpacing: '0.5px' }}>進化による主要数値変化</h4>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px', textAlign: 'center' }}>
            <div style={{ background: 'var(--bg-inset)', padding: '24px', borderRadius: '16px', border: '1px solid var(--border-color)' }}>
              <span style={{ fontSize: '13px', color: 'var(--text-muted)', fontWeight: '700' }}>安定歩行率</span>
              <div style={{ fontSize: '28px', fontWeight: '900', marginTop: '12px', color: 'var(--text-title)' }}>
            ...
            <div style={{ background: 'var(--bg-inset)', padding: '24px', borderRadius: '16px', border: '1px solid var(--border-color)' }}>
              <span style={{ fontSize: '13px', color: 'var(--text-muted)', fontWeight: '700' }}>平均前進距離</span>
              <div style={{ fontSize: '28px', fontWeight: '900', marginTop: '12px', color: 'var(--text-title)' }}>
            ...
            <div style={{ background: 'var(--bg-inset)', padding: '24px', borderRadius: '16px', border: '1px solid var(--border-color)' }}>
              <span style={{ fontSize: '13px', color: 'var(--text-muted)', fontWeight: '700' }}>転倒リタイア率</span>
              <div style={{ fontSize: '28px', fontWeight: '900', marginTop: '12px', color: 'var(--text-title)' }}>
        ...
        <div className="card" style={{
          ...
          <div>
            ...
            <p style={{ fontSize: '14px', color: 'var(--text-main)', margin: '0', lineHeight: '1.7', paddingLeft: '36px' }}>
        ...
        <div className="card" style={{
          ...
          >
            ...
            <span style={{ fontSize: '14px', color: 'var(--text-muted)' }}>{isReportOpen ? '▲ 折りたたむ' : '▼ 展開する'}</span>
          </button>
          
          {isReportOpen && (
            <div className="fade-in" style={{ marginTop: '24px', borderTop: '1px solid var(--border-color)', paddingTop: '24px', fontSize: '14px', color: 'var(--text-main)', lineHeight: '1.8' }}>
              <h5 style={{ fontWeight: '800', color: 'var(--text-title)', marginBottom: '12px', fontSize: '15px' }}>遺伝的アルゴリズムの仕組み</h5>
              <p style={{ marginBottom: '24px' }}>
                本シミュレーターは、ニューラルネットワークを用いず、各ロボット個体の歩行特性（歩幅 <code>strideLength</code>、歩行リズム <code>stepRhythm</code>、姿勢補正力 <code>balanceCorrection</code>、ふらつき量 <code>wobbleStrength</code>、立て直す力 <code>recoveryAbility</code>、前進速度 <code>speedFactor</code>、横揺れの振幅 <code>lateralAmplitude</code>、中央へ戻る力 <code>centerPull</code> など全12個のパラメータ）を<b>「ゲノム（DNA）」</b>として定義しています。
              ...
              <h5 style={{ fontWeight: '800', color: 'var(--text-title)', marginBottom: '12px', fontSize: '15px' }}>UI/UXとフロントエンド設計意図</h5>
              <p style={{ marginBottom: '24px' }}>
                ...
                また、世代数の多さに起因する「ユーザーの待機ストレス」を解消するため、<b>再生倍速機能（1 / 2 / 5 / 10 / 50倍速）</b>や、対象個体を追う<b>カメラトラッキング</b>などを実装しています。
              </p>

              <h5 style={{ fontWeight: '800', color: 'var(--text-title)', marginBottom: '12px', fontSize: '15px' }}>診断メトリクス実績</h5>
              <ul style={{ paddingLeft: '24px', color: 'var(--text-main)', margin: '0' }}>
